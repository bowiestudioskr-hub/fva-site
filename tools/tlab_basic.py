...
SPECS = [
    ...
    # 혜택 캡슐 — 주황(3697:33235/33337) · 초록(3697:33343/33419)
    ('b-theater', ['극장 상영 기회 제공'],   129.712, -3.8914, None, '극장 상영 기회 제공'),
    ('b-ticket',  ['& 관람 티켓 2매 증정'],  114.325, -3.4297, None, '& 관람 티켓 2매 증정'),
    # 「촬영 & 조명 워크샵」은 & 만 작다(142.61 / 113.761) → 세 조각으로 나눠 만든다
    ('b-ws1', ['촬영'],       142.61,  -4.2783, None, '촬영'),
    ('b-ws2', ['&'],          113.761, -3.4128, None, '&'),
    ('b-ws3', ['조명 워크샵'], 142.61,  -4.2783, None, '조명 워크샵'),
    ('b-party', ['네트워킹 파티 초대권 증정'], 97.84, -2.9352, None, '네트워킹 파티 초대권 증정'),
    # ── 상페3 ─────────────────────────────────────────────
    # 21STUDIOS - 스토리 IP 전문 제작사 (3684:17714) TLAB 70px 자간 -2.8 #2CFF05
    ('b-21studios', ['21STUDIOS - 스토리 IP 전문 제작사'], 70.0, -2.8, None,
     '21STUDIOS - 스토리 IP 전문 제작사'),
    # 실적 번호 (3684:17792 외) TLAB 27.013px 자간 0 #AAD8F9
    ('b-c01', ['01'], 27.013, 0.0, None, '01'),
    ('b-c02', ['02'], 27.013, 0.0, None, '02'),
    ('b-c03', ['03'], 27.013, 0.0, None, '03'),
    ('b-c04', ['04'], 27.013, 0.0, None, '04'),
    ('b-c05', ['05'], 27.013, 0.0, None, '05'),
    ('b-c06', ['06'], 27.013, 0.0, None, '06'),
    # 강사 이름 (3684:17830) TLAB 143.333px 자간 -5.7333 #08FFD0
    ('b-hugo', ['HUGO'], 143.333, -5.7333, None, 'HUGO'),
    # 수상한 아카데미 (3697:33465) TLAB 120.82px 자간 0 #2CFF05
    ('b-award', ['수상한 아카데미'], 120.82, 0.0, None, '수상한 아카데미'),
]
